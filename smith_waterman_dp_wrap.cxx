...
/*-----------------------------------------------
              @(target):= _smith_waterman_dp.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__smith_waterman_dp

#else
#  define SWIG_init    init_smith_waterman_dp

#endif
#define SWIG_name    "_smith_waterman_dp"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_local_pairwise_align(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg17 = &temp17;
  arg18 = &temp18;
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOO:local_pairwise_align",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1
    };
  ...
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "local_pairwise_align" "', argument " "5"" of type '" "double""'");
  } 
  arg5 = static_cast< double >(val5);
  ecode6 = SWIG_AsVal_double(obj3, &val6);
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "local_pairwise_align" "', argument " "6"" of type '" "double""'");
  } 
  ...
  local_pairwise_align(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18);
  ...
  if (SWIG_IsTmpObj(res17)) {
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_From_int((*arg17)));
  } else {
    int new_flags = SWIG_IsNewObj(res17) ? (SWIG_POINTER_OWN |  0 ) :  0 ;
    resultobj = SWIG_Python_AppendOutput(resultobj, SWIG_NewPointerObj((void*)(arg17), SWIGTYPE_p_int, new_flags));
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"local_pairwise_align", _wrap_local_pairwise_align, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_Python_SetConstant(d, "kN",SWIG_From_int(static_cast< int >(600)));
  SWIG_Python_SetConstant(d, "kM",SWIG_From_int(static_cast< int >(600)));
  SWIG_Python_SetConstant(d, "kPenalizeTerminalGaps",SWIG_From_int(static_cast< int >(0)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
